...
#ifndef AP_APP_LAYER_H
#define AP_APP_LAYER_H
 ...
 * @author Daniel Willkomm
 **/
class MIXIM_API APAppLayer : public BaseApplLayer
{
  public:
    APAppLayer();
    virtual ~APAppLayer();
...
private:
     ...
     */
    APAppLayer(const APAppLayer&);
    /** @brief Assignment operator is not allowed.
     */
    APAppLayer& operator=(const APAppLayer&);
...
protected:
    ...
    /** @brief Convert latitude, longitude to meter positions */
