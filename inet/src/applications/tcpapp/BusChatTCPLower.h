...
#ifndef __INET_BusChatTCPLower_H
#define __INET_BusChatTCPLower_H
 ...
 */
class INET_API BusChatTCPLower : public cSimpleModule, public TCPSocket::CallbackInterface
{
  protected:
    TCPSocket socket;
  ...
  protected:
    ...
    virtual void sendPacket(DataPacket *p, bool serverClose = false);
