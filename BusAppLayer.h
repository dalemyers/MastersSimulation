...
#ifndef BUS_APP_LAYER_H
#define BUS_APP_LAYER_H
 ...
 * @author Daniel Willkomm
 **/
class MIXIM_API BusAppLayer : public BaseApplLayer
{
  public:
    BusAppLayer();
    virtual ~BusAppLayer();
...
private:
     ...
     */
    BusAppLayer(const BusAppLayer&);
    /** @brief Assignment operator is not allowed.
     */
    BusAppLayer& operator=(const BusAppLayer&);
